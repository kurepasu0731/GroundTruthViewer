...
cv::Mat t1 = cv::Mat::zeros(3,1,CV_64F); //camera1
cv::Mat t2 = cv::Mat::zeros(3,1,CV_64F); //camera2
...
void draw_correspondPoints()
{
	...
	glColor3f(0, 255, 0); //camera1
	glVertex3d(t1.at<double>(0,0), t1.at<double>(1,0), t1.at<double>(2,0));
	glColor3f(0, 0, 255); //camera2
	glVertex3d(t2.at<double>(0,0), t2.at<double>(1,0), t2.at<double>(2,0));
...
int main(int argc, char **argv){
	...
	gluPerspective(45.0f, (float)width/height, 0.01f, 100.0f); //クリッピング領域指定
